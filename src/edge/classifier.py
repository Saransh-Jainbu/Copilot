...
CATEGORY_RULES = {
    ...
    "secrets": {
        "keywords": [
            ...
            "required, but not provided", "not provided while calling",
            "secret huggin", "inherit secrets", "organization secret",
        ],
        "weight": 1.1,
    },
    "cicd_platform": {
        "keywords": [
            ...
            "workflow_call", "actions: none", "issues: none",
            "permissions", "caller workflow", "reusable workflow",
        ],
        "weight": 1.0,
    },
}
